    ...
    return (
      <div className="flex h-screen bg-background">
        ...
        <div className="flex flex-1 flex-col">
          <SearchFormulaWorkflow fileName={uploadedFileName} onBack={handleBackFromWorkflow} />
        </div>
      </div>
    )
  }
  ...
  if (showReport) {
    return (
      <div className="flex h-screen bg-background">
        <ChatSidebar />
        <div className="flex flex-1 flex-col">
          <ReportWorkflow fileName={uploadedFileName} onBack={handleBackFromWorkflow} />
        </div>
      </div>
    )
  }
  ...
  if (showDisclosure) {
    return (
      <div className="flex h-screen bg-background">
        <ChatSidebar />
        <div className="flex flex-1 flex-col">
          <DisclosureWorkflow fileName={uploadedFileName} onBack={handleBackFromWorkflow} />
        </div>
      </div>
    )
  }
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <footer className="flex items-center justify-center py-3 text-xs text-muted-foreground">
          <span>专利智能助手由先进AI技术驱动，内容仅供参考</span>
        </footer>
      </div>
    </div>
  )
